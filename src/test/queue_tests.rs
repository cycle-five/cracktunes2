...
mod queue_tests {
    ...
    fn create_test_track(id: &str) -> ResolvedTrack {
        ResolvedTrack::new(QueryType::VideoLink(format!("https://www.youtube.com/watch?v={}", id)))
    ...
    async fn test_queue_insert() {
        ...
        // Check order
        assert_eq!(queue.get(0).await.unwrap().get_url(), "https://www.youtube.com/watch?v=1");
        assert_eq!(queue.get(1).await.unwrap().get_url(), "https://www.youtube.com/watch?v=2");
        assert_eq!(queue.get(2).await.unwrap().get_url(), "https://www.youtube.com/watch?v=3");
    }
    ...
    async fn test_queue_append() {
        ...
        assert_eq!(queue.get(2).await.unwrap().get_url(), "https://www.youtube.com/watch?v=3");
        assert_eq!(queue.get(3).await.unwrap().get_url(), "https://www.youtube.com/watch?v=4");
        ...
        assert_eq!(queue.get(4).await.unwrap().get_url(), "https://www.youtube.com/watch?v=5");
        assert_eq!(queue.get(5).await.unwrap().get_url(), "https://www.youtube.com/watch?v=6");
    }
    ...
    async fn test_queue_shuffle() {
        ...
        assert!(all_present, "All tracks should still be present after shuffle");
    }
